...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Not quite... you answer ${userAnswer}. The correct answer was ${calculatedAnswer[0]}`);
...
/**
 * gets current score form dom and increases by 1
 */
...
/**
 * gets current incorrect tally form dom and increases by 1
 */
